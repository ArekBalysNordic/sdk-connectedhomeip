...
class NordicDevKitCluster(
  ...
  suspend fun setLED(action: UByte, timedInvokeTimeout: Duration? = null) {
    val commandId: UInt = 4293984256u

    val tlvWriter = TlvWriter()
    tlvWriter.startStructure(AnonymousTag)

    val TAG_ACTION_REQ: Int = 0
  ...
  suspend fun readDevKitNameAttribute(): String {
    val ATTRIBUTE_ID: UInt = 4293984256u
    ...
    requireNotNull(attributeData) { "Devkitname attribute not found in response" }
  ...
  suspend fun writeDevKitNameAttribute(value: String, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 4293984256u
  ...
  suspend fun subscribeDevKitNameAttribute(
    minInterval: Int,
    maxInterval: Int,
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Devkitname attribute not found in Node State update" }
  ...
  suspend fun readUserLEDAttribute(): Boolean {
    val ATTRIBUTE_ID: UInt = 4293984257u
    ...
    requireNotNull(attributeData) { "Userled attribute not found in response" }
  ...
  suspend fun readUserButtonAttribute(): Boolean {
    val ATTRIBUTE_ID: UInt = 4293984258u
    ...
    requireNotNull(attributeData) { "Userbutton attribute not found in response" }
  ...
  companion object {
    private val logger = Logger.getLogger(NordicDevKitCluster::class.java.name)
