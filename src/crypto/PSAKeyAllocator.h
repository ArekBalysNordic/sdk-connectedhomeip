...
public:
     ...
     * Each keys must be allocated separately.
     *
     ...
     *
     * @param attrs Pointer to the key attributes structure to be updated.
     */
 ...
 *
 * This default implementation uses the legacy approach of providing keys according to the KeyIdBase enum.
 ...
 *
 * @return PSAKeyAllocator* Pointer to the singleton instance of PSAKeyAllocator.
 */
...
{
    VerifyOrDie(keyAllocator != nullptr);
