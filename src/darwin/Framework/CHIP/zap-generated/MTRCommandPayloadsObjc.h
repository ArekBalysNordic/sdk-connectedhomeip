...
@interface MTRBasicInformationClusterGenerateRandomParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRNordicDevKitClusterSetLEDParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nonnull action MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
