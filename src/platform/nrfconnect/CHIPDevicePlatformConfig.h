...
#define CHIP_CONFIG_ADDRESS_RESOLVE_MIN_LOOKUP_DEFAULT_TIME_MS CONFIG_CHIP_ADDRESS_RESOLVE_MIN_LOOKUP_DEFAULT_TIME_MS
#endif

#ifndef CHIP_CONFIG_ADDRESS_RESOLVE_MAX_LOOKUP_DEFAULT_TIME_MS
#define CHIP_CONFIG_ADDRESS_RESOLVE_MAX_LOOKUP_DEFAULT_TIME_MS CONFIG_CHIP_ADDRESS_RESOLVE_MAX_LOOKUP_DEFAULT_TIME_MS
#endif
