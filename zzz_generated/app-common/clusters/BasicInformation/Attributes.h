...
struct TypeInfo
{
    ...
    static constexpr ClusterId GetClusterId() { return Clusters::BasicInformation::Id; }
    static constexpr AttributeId GetAttributeId() { return Attributes::RandomNumber::Id; }
    static constexpr bool MustUseTimedWrite() { return false; }
};
} // namespace RandomNumber
...
struct TypeInfo
{
    struct DecodableType
    {
        ...
        Attributes::RandomNumber::TypeInfo::DecodableType randomNumber                 = static_cast<uint16_t>(0);
